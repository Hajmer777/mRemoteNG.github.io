...
<svelte:head>
	...
	<!-- Bootswatch: Darkly theme (сохраняем оригинальный вид) -->
	<link
		rel="stylesheet"
	...
	<link rel="preload" href="{base}/js/theme-loader.js" as="script" />

	<!-- Load with async to avoid render-blocking -->
	<script src="{base}/js/theme-loader.js" async></script>

	<!-- Bootstrap JS (bundle, чтобы работали Popper/Dropdown/Tooltip) -->
	<script
		src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist/js/bootstrap.bundle.min.js"
		integrity="sha384-2Qki2X3XrXkq3VtWm2d8Wju7lB8h4rVQy7R2r1qg7Gg1c0qa9t3v3Jf9mGk8y1QK"
		crossorigin="anonymous">
	</script>
</svelte:head>
